# Duelo de Amigos — Arena de Poder ⚔️🟢
...
## Controles 🕹️
- **+ Jogador**: adiciona jogadores extras (até 4).
- **Iniciar Duelo**: começa a partida.
- **Resetar**: reinicia a página.

## Power‑ups ✨
- **ATK**: aumenta o dano.
- **DEF**: reduz dano recebido.
- **VEL**: aumenta a velocidade.
- **VIDA**: aumenta a vida total e recupera HP.
